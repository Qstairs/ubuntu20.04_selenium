...
# chrome browser
# ARG BROWSER=76.0.3809.100
ARG BROWSER=80.0.3987.149
RUN wget https://www.slimjetbrowser.com/chrome/files/${BROWSER}/google-chrome-stable_current_amd64.deb -O google-chrome-stable_current_amd64.deb
# RUN wget https://www.slimjet.com/chrome/download-chrome.php?file=files%2F${BROWSER}%2Fgoogle-chrome-stable_current_amd64.deb -O google-chrome-stable_current_amd64.deb
...
# chrome driver
# ARG DRIVER=76.0.3809.126
ARG DRIVER=80.0.3987.106
RUN curl -OL https://chromedriver.storage.googleapis.com/${DRIVER}/chromedriver_linux64.zip
